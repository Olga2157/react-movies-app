...
type SortOrderButtonState = {}

class SortOrderButton extends React.Component<SortOrderButtonProps, SortOrderButtonState> {
  render() {
    const { sortOrder, listener } = this.props;
    if (sortOrder === 'asc') {
      return (
        // asc
        <button type="button" className="w-25" onClick={listener}>
